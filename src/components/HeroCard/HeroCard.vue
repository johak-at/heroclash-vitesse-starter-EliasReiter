...
<template>
  ...
  <div grid class="heroCard">
    ...
    <HeroModal  v-if="showBiography" :name="hero.name" :appearance="hero.appearance" :biography="hero.biography" :connections="hero.connections" :work="hero.work" @hideBiography="showBiography = false"
  />
  </div>
</template>
